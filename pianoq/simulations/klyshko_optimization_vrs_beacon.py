...
class KlyshkoBeaconSimulationResult(object):
    ...
    def show(self):
        ...
        ax.errorbar(self.ctrls, self.klyshkos, yerr=self.klyshko_stds, fmt='o', label='klyshkos')
        ax.errorbar(self.ctrls, self.beacon_one_ways, yerr=self.beacon_one_way_stds, fmt='o', label='beacon_one_way')
        ax.errorbar(self.ctrls, self.beacon_two_ways, yerr=self.beacon_two_way_stds, fmt='o', label='beacon_two_way')
