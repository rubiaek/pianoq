    ...
    def scan(self, spiral=False, ph=None , x_motor=None, y_motor=None):
        if ph is None:
            ...
            if self.is_timetagger:
                ph = QPTimeTagger(integration_time=self.integration_time, coin_window=self.coin_window, single_channel_delays=(13800, 0))
            else:
...
if __name__ == '__main__':
    ...
    middle_scan(integration_time=3, name='try_2_speckle', is_timetagger=True, coin_window=1e-9)
